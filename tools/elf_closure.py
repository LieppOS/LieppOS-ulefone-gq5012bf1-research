...
def main():
    ...
    ap.add_argument("--aosp-replaced", default=None,
                    help="stock paths owned by AOSP/ROM modules; defaults to "
                         "aosp-replaced-files.txt in this research checkout")
    ...
    aosp_replaced = args.aosp_replaced or os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        "aosp-replaced-files.txt",
    )
    aosp = set(read_list(aosp_replaced))
